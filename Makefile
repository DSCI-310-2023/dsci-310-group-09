...
results/bike_histogram.png results/bike_correlations_ggpairs.png results/reg_bike_count_temp.png results/reg_bike_count_solar_rad.png results/knn_bike_count_temp.png results/knn_bike_count_solar_rad.png: source/generate_figures.R
	Rscript source/generate_figures.R --input_dir="https://archive.ics.uci.edu/ml/machine-learning-databases/00560/SeoulBikeData.csv" --out_dir="results"
