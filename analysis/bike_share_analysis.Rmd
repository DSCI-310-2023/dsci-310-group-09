...
The next linear regression model uses solar radiation as the sole predictor. This leads to a RMSE value of `r lm_rmse_2` and a RMSPE value of `r lm_rmspe_2`. The equation for the best fit line is $y = 4602 + 23038x_1$ where $y =$ number of bikes rented per day, and $x_1 =$ solar radiation $(MJ/m^2)$.
