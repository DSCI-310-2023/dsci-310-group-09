...
This model requires `r k_min_1` neighbors for the lowest error value. It results in an RMSPE value of `r knn_rmspe_1`. Below is a scatter plot that demonstrates the data with the predictive model.
...
This model requires `r k_min_2` neighbors for the lowest error value. It results in an RMSPE value of `r knn_rmspe_2`. Below is a scatter plot that demonstrates the data with the predictive model.
